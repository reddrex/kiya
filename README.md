...
We followed an adapted version of the IThaKA pattern design, leaving out the dual index structure of common and specific knowledge, as we weren't going to reuse the chatbot and it was a small PoC that wasn't going to have much personality (common knowledge).
